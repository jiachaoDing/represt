...
const pinyinAliasesByExerciseId: Record<string, string[]> = {
  ...
  deadBug: ['sc'],
  birdDog: ['ng'],
  abCrunchMachine: ['qxjf'],
  machineChestPress: ['qxxt'],
  dumbbellFly: ['ylfn'],
  inclineDumbbellFly: ['sxylfn'],
  smithMachineBenchPress: ['smswt'],
  invertedRow: ['fxhc'],
  reverseGripBarbellRow: ['fsglhc'],
  gobletSquat: ['gjbsd'],
  smithMachineSquat: ['smssd'],
  boxSquat: ['xssd'],
  dumbbellStepUp: ['yldt'],
  barbellStepUp: ['gldt'],
  gluteKickback: ['tbht'],
  seatedLegCurl: ['zztwj'],
  machineShoulderPress: ['qxjt'],
  uprightBarbellRow: ['glzlhc'],
  cableInternalRotation: ['ssjnx'],
  ezBarCurl: ['ezgwj', 'qgwj'],
  inclineDumbbellCurl: ['sxylwj'],
  abRollout: ['jfl'],
  cableOverheadTricepsExtension: ['ssgdbqs'],
  cableHammerCurl: ['sscswj'],
  highCableCurl: ['gwsswj'],
  sidePlank: ['cpbzc'],
  obliqueCrunch: ['cfjf'],
  exerciseBallCrunch: ['jsqjf'],
}
